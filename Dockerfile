...
RUN apt install mesa-opencl-icd
#RUN apt install ocl-icd-opencl-dev gcc git bzr jq pkg-config curl clang build-essential hwloc libhwloc-dev wget -y && apt upgrade -y
